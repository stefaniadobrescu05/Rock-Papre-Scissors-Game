...
def draw_ui_elements(
    ...
    Args:
        frame: Frame-ul video de la camera
        score: Dictionar cu scorul
        instruction: Textul cu instructiuni
        detection_status: Status detectie
        detected_gesture: Gestul detectat in timp real
        winner: Castigatorul rundei
        player_move: Mutarea jucatorului
        computer_move: Mutarea computerului
        roi: Region of Interest
    
    Returns:
        Frame cu elementele UI desenate
    """
    if frame is None:
        return None
